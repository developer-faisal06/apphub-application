    ...
    return (
        <div className='container m-auto ' >
           <div className="title m-4">
                     ...
                     <div  className="card bg-base-300 w-full shadow-sm">
                        ...
                        <div className="card-body">
                            ...
                            <div className="card-actions justify-between">
                                <span className='bg-amber-50 px-1 text-black rounded' >{formatDownloads(data.downloads)}</span>
                               <div className='flex bg-amber-50 px-1 text-black rounded items-center'>
            ...
            <Link to={'/app'} className=" mt-4 btn bg-blue-600 text-white border-0 hover:bg-primarydark ">
                        install
                    </Link>
        </div>
    );
